...
const Hero = () => {
  return (
    <div className="bg-architect-light py-12 md:py-20">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-display font-medium text-architect-dark leading-tight">
            Design que Transforma Espaços
          </h1>
